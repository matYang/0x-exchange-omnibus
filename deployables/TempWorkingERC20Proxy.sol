...
// File: contracts/0x_v3/utils/interfaces/IAuthorizable.sol
    ...
    IOwnable
{
    ...
    /// @return addresses Array of authorized addresses.
...
// File: contracts/0x_v3/asset-proxy/archive/MixinAuthorizable.sol
...
// File: contracts/0x_v3/asset-proxy/ERC20Proxy.sol
        ...
        external
    {
        assembly {
            ...
            if eq(selector, 0xa85e59e400000000000000000000000000000000000000000000000000000000) {
                ...
                // IMPORTANT: OVM has errors in returndatasize and returndatacopy, and it is not meaningful to
                // enforce return data byte size, we just need it to be bool true or nothing
                

                // success := or(success, iszero(returndatasize()))
                // return(0, 0)
